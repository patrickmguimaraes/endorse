(function($) {
    ...
    function addNewClass() { 
        $('#loginComponent').imagesLoaded().done(function(instance) {
            $('#loginComponent').addClass('loaded');
        });

        $('#signupComponent').imagesLoaded().done(function(instance) {
            $('#signupComponent').addClass('loaded');
        });
    }
    ...
    Youtube Video
    -------------------------------------*/
    if ($.fn.YTPlayer !== undefined && $("#fxtVideoLogin").length) {
        $("#fxtVideoLogin").YTPlayer({ useOnMobile: true });
    }

    if ($.fn.YTPlayer !== undefined && $("#fxtVideoSignup").length) {
        $("#fxtVideoSignup").YTPlayer({ useOnMobile: true });
    }
